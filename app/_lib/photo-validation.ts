/**
 * Fotoğraf sayısı sınırları — projenin TEK merkezi karar noktası, HER
 * çağıran (job-photo-upload.tsx, job-photo-editor.tsx, job-request-form.tsx,
 * job-edit-form.tsx, job-form-validation.ts, job-store.ts) buradan okur.
 *
 * "Production Fotoğraf Yükleme Hatası ve Minimum 1 Fotoğraf Kuralı" görevi:
 * eskiden Depo Hizmetleri grubu ve Nakliye için ayrı, daha geniş bir aralık
 * (4-15) uygulanıyordu (bkz. git geçmişi) — bu istisna KALDIRILDI, artık
 * TÜM kategoriler (Depo Hizmetleri ve Nakliye dahil) için TEK aralık
 * geçerlidir. Eski minimum 4 kuralı, hangi kategoriden gelirse gelsin
 * artık geçersizdir.
 */
...
export const PHOTOS_REQUIRED_MESSAGE =
  "Devam edebilmek için en az 1 fotoğraf yüklemelisiniz.";
